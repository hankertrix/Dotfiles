...
Set the default font to Cascadia Code with a font size of 12.
#+begin_src emacs-lisp
...
Set the default mono space font to Cascadia Code with a font size of 12.
#+begin_src emacs-lisp
...
This shows a column on the right that marks the maximum number of characters you should have in a line.
#+begin_src emacs-lisp
