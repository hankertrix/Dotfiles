...
[mason.nvim](https://github.com/williamboman/mason.nvim) with
...
MDX syntax highlighting - [mdx.nvim](https://github.com/davidmh/mdx.nvim)
...
Guessing indentation - [vim-sleuth](https://github.com/tpope/vim-sleuth)

Better quick fix list - [quicker.nvim](https://github.com/stevearc/quicker.nvim)
...
Help file previewer - [helpview.nvim](https://github.com/OXY2DEV/helpview.nvim)
...
Typr typing plugin - [typr](https://github.com/nvzone/typr)
...
The language servers below are shared with my Emacs configuration, so they are
installed globally on my system instead of through Mason.
...
- [ty](https://archlinux.org/packages/extra/x86_64/ty/)

### Formatters and linters

The formatters and linters below are also shared with my Emacs configuration, so
they are installed globally on my system instead of through Mason.
