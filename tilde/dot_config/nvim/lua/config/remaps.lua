...
vim.keymap.set(
	...
	"n",
	"nzzzv",
	{ desc = "Continue searching in the same direction of the previous search" }
)
vim.keymap.set("n", "N", "Nzzzv", {
	desc = "Continue searching in the opposite "
...
vim.keymap.set(
	...
	"*",
	"*zzzv",
	{ desc = "Search the word under the cursor in the forward direction" }
)
vim.keymap.set(
	"n",
	"#",
	"#zzzv",
	{ desc = "Search the word under the cursor in the backward direction" }
)
...
vim.keymap.set(
	...
	"<C-/>",
	"gcc",
	{ remap = true, desc = "Toggle comment for a line" }
)
vim.keymap.set(
	"v",
	"<C-/>",
	"gc",
	{ remap = true, desc = "Toggle comment for a region" }
)
vim.keymap.set(
	"o",
	"<C-/>",
	"gc",
	{ remap = true, desc = "Get largest commented block near the cursor" }
)
...
vim.keymap.set(
	...
	"<Leader>Y",
	[["+y$]],
	{ desc = "Yank till the end of the line to system clipboard" }
)
...
vim.keymap.set(
	...
	"<Leader>p",
	[["+p]],
	{ desc = "Paste from system clipboard after the cursor" }
)
vim.keymap.set(
	{ "n", "v" },
	"<Leader>P",
	[["+P]],
	{ desc = "Paste from system clipboard before the cursor" }
)
...
vim.keymap.set(
	...
	{
		desc = "Replace the word hovered by the cursor "
...
vim.keymap.set(
	...
	"<C-space>",
	[[<C-\><C-n>]],
	{ desc = "Escape the terminal prompt and enter normal mode" }
)
