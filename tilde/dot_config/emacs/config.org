...
(use-package general
  ...
  (hanker/leader-keys
    :states '(normal visual)
    "jw" '("Open Dired" . dired)
    "jf" '("Search for a file" . find-file)
    )
...
(use-package lsp-ui
  ...
  (general-def
    ...
    "grn" '("Renames all references to the symbol under the cursor" . lsp-rename)
    "gra" '("Select a code action" . lsp-execute-code-action)
    "grr" '("List all references" . lsp-ui-peek-find-references)
    "gri" '("List all implementations" . lsp-ui-peek-find-implementation)
    "grt" '("Go to type definition" . lsp-find-type-definition)
    "gO" '("Find document symbol" . lsp-ui-peek-find-workspace-symbol)
    "[d" '("Go to previous diagnostic" . flycheck-previous-error)
    "]d" '("Go to next diagnostic" . flycheck-next-error)
    "grd" '("Go to definition" . lsp-ui-peek-find-definitions)
    "grD" '("Go to declaration" . lsp-find-declaration)
    "grs" '("Show signature information" . lsp-signature-activate)
    )

  ;; Key binds for insert mode in LSP mode
  (general-def
    :keymaps 'lsp-mode-map
    :states 'insert
    "C-s" '("Show signature information" . lsp-signature-activate)
    )
...
(use-package vertico
  ...
  :ensure (vertico :host github :repo "minad/vertico" :files (:defaults "extensions/*") :ref "e4338c5bae2c725be2940726be170bc034af3b6c")
...
(use-package marginalia
  ...
  ;; Pin to the last commit before compat 31
  :ensure (:ref "4a0628dfdf944a5d307d31d2a514825cc5386986")
...
(use-package consult
  ...
  (hanker/leader-keys
    ...
    "js" '("Search within files for a string" . consult-ripgrep)
    "jb" '("Search through the open buffers" . consult-buffer)
    "jr" '("Search through Emacs registers" . consult-register-load)
    "jl" '("Search through the lines in the current buffer" . consult-line)

    ;; https://emacs.stackexchange.com/questions/82850/call-execute-extended-command-with-prefilled-prefix-string
    "jp" '("Search through the list of pickers" .
           (lambda ()
             (interactive)
...
(use-package corfu
  ...
  :ensure (corfu :host github :repo "minad/corfu" :files (:defaults "extensions/*") :ref "856171ac98c3aaa629caa011be7cd3a9405e6e0f")
...
(use-package cape
  ...
  ;; Pin to the last commit before compat 31
  :ensure (:ref "2e15e1909754752f66096dde1b8d639d6eb25f35")
...
(use-package org-modern
  ...
  ;; Pin to the last commit before compat 31
  :ensure (:ref "713beb72aed4db43f8a10feed72136e931eb674a")
...
- [[https://archlinux.org/packages/extra/x86_64/ty/][ty]]
